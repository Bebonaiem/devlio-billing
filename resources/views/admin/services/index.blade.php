                ...
                <tbody class="divide-y divide-white/5">
                    @forelse ($services as $service)
                        <tr class="hover:bg-white/[0.02] transition">
                            ...
                            <td class="px-6 py-4">
                                <span class="text-sm text-white">{{ $service->user->first_name }} {{ $service->user->last_name }}</span>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center text-dark-500">No services found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
