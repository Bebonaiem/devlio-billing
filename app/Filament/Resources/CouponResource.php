                ...
                Forms\Components\Section::make('Coupon Details')
                    ->schema([
                        ...
                        Forms\Components\TextInput::make('recurring')
                            ->numeric()
                            ->helperText('Number of invoices the discount applies to. Leave empty for unlimited.'),
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('value')
                    ->formatStateUsing(fn ($state, $record): string => $record->type === 'percentage' ? "{$state}%" : number_format($state, 2)),
                ...
                Tables\Columns\IconColumn::make('expired')
                    ->boolean()
                    ->state(fn ($record): bool => $record->expires_at && $record->expires_at->isPast()),
            ])
            ->filters([
